...
Gp_Result gp_write_varint(void *buffer, Gp_Varint val, Gp_Read_Byte_From_Buffer write);
Gp_Result gp_write_varlong(void *buffer, Gp_Varlong val, Gp_Read_Byte_From_Buffer write);
